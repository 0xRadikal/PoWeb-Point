...
import { getStyleClasses, getLayoutClasses } from './slideStyleUtils';
...
const ImageWithFallback = ({ src, alt, className, style, ...props }: React.ImgHTMLAttributes<HTMLImageElement>) => {
