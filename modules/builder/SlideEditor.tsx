        ...
        <div className="flex flex-col h-full bg-white dark:bg-slate-950 overflow-y-auto no-scrollbar">
            ...
            <div className="h-14 border-b border-slate-200 dark:border-slate-800 flex items-center px-4 justify-between shrink-0 bg-white dark:bg-slate-950 sticky top-0 z-10">
                 ...
                 <div className="flex gap-1 items-center">
                     <button onClick={() => deleteSlide(activeSlide.id)} className="text-slate-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 p-2 rounded-md transition-colors" title={t.delete} aria-label={t.delete}>
                     ...
                     {onClose && (
                        <button onClick={onClose} className="text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 p-2 rounded transition-colors" title={t.a11yCloseMenu} aria-label={t.a11yCloseMenu}>
                            <span className="md:hidden"><X size={18} aria-hidden="true" /></span>
                            <span className="hidden md:inline"><PanelRightClose size={16} aria-hidden="true" /></span>
                        </button>
                     )}
                 </div>
            </div>
